...
import com.fxz.dnscore.common.utils.DnsCodecUtil;
...
public class DefaultDnsRecordEncoder  implements DnsRecordEncoder{
    ...
    protected void encodeName2(String name, ByteBuf buf) throws Exception {
        DnsCodecUtil.encodeDomainNameNative(name, buf);
    }
